...
import { fetchWaitingForMeTasks } from '@/services/task/taskServices';
...
const TasksWaitingForMe: FC<TasksWaitingForMeProps> = ({ className }) => {
  ...
  const {
    ...
    error,
    refetch,
  } = usePaginatedTaskService(fetchWaitingForMeTasks, paginationParams);
