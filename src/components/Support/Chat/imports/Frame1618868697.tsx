import svgPaths from "./svg-0dqf7vdgz1";
...
function ConversationMessagesDateTime() {
  return (
    <div className="content-stretch flex gap-[16px] h-full items-center justify-end relative shrink-0" data-name="conversation/messages/date_time">
      <p className="font-['IRANSansXFaNum:Regular',sans-serif] leading-[24px] not-italic relative shrink-0 text-[#5e758e] text-[10px] text-nowrap whitespace-pre">امروز، ۱۳:۳۰</p>
    </div>
  );
}
      ...
      <div className="flex flex-col justify-center overflow-clip rounded-[inherit] size-full">
        <div className="box-border content-stretch flex flex-col gap-[4px] items-start justify-center px-[16px] py-[8px] relative w-full">
          <p className="font-['IRANSansXFaNum:Regular',sans-serif] leading-[normal] not-italic relative shrink-0 text-[#131d28] text-[12px] text-right w-full" dir="auto">
            این متن شامل پیام توضیحات می باشد.
          </p>
          <Frame7 />
        </div>
      </div>
...
function ConversationMessagesDateTime1() {
  return (
    <div className="content-stretch flex gap-[16px] h-full items-center justify-end relative shrink-0" data-name="conversation/messages/date_time">
      <p className="font-['IRANSansXFaNum:Regular',sans-serif] leading-[24px] not-italic relative shrink-0 text-[#5e758e] text-[10px] text-nowrap whitespace-pre">۲۴ تیر ۱۴۰۳، ۱۳:۴۵</p>
    </div>
  );
}
  ...
  return (
    <div className="bg-white relative rounded-[24px] size-full">
      <div className="flex flex-col items-end size-full">
        <div className="box-border content-stretch flex flex-col gap-[40px] items-end overflow-clip px-[24px] py-[40px] relative size-full">
          <Frame8 />
          <Frame12 />
          <Frame4 />
        </div>
